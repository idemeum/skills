...
Only `outcome: "failed-items"` continues. On anything else, skip Steps 7–9 and escalate with the tool's `message` verbatim — it already leads with the check-in age and names the provider.
